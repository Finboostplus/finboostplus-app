...
public class GroupController {
	...
	public ResponseEntity<Page<GroupMemberResponseDTO>> findAllMembersByGroupId(@PathVariable Long groupId,
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by("user_name").ascending());
		return new ResponseEntity<>(groupService.findAllMembersByGroupId(groupId, pageable, search),
				HttpStatus.OK);
	}
