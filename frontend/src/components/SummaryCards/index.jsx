...
export default function SummaryCards() {
  ...
  const totalMonthlySpentBRL = {
    total: formatBRL(current_user.dashboard.totalMonthlySpent),
    color:
      current_user.dashboard.totalMonthlySpent > 0
  ...
  return (
    <CardUI className="max-md:flex max-md:flex-col mb-6">
      {/* Saldo Total */}
      {/* <CardUI
      ...
      {/* Total Gasto */}
      <CardUI
        className={`relative p-6 rounded-2xl shadow-md border border-muted bg-neutral text-text transition-colors`}
      >
